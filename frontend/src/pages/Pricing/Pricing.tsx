...
const Pricing: React.FC = () => {
  ...
  const handleActivateFreePlan = async (planId: string) => {
    try {
      ...
      setShowActivatedPopup(true); // Show the popup
  ...
  // Close activated popup and navigate to /exam
  const closeActivatedPopup = () => {
    setShowActivatedPopup(false);
    setActivationError(null);
    navigate("/exams"); // Navigate to /exam page
  };
                ...
                {pricePlans.map((plan) => (
                  ...
                  >
                    ...
                    {plan.price === 0 ? (
                      ...
                      >
                        {pendingPlanId === plan._id ? "Pending..." : "Purchase"}
                      </button>
                    )}
                  </div>
                ))}
