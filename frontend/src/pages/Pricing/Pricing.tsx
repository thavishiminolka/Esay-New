...
//   const message =
//     "Hello, I've made the payment for the exam package. Here's my payment slip:";
...
//               Please send your payment slip to our WhatsApp number to complete
//               your purchase.
//             </p>
//             <a
//               href={whatsappLink}
...
//               className="block bg-green-500 text-white py-2 px-4 rounded-lg text-center hover:bg-green-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
//               aria-label="Open WhatsApp to send payment slip"
//             >
//               Open WhatsApp
//             </a>
//             <button
//               onClick={closePopup}
//               className="mt-4 w-full bg-gray-200 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-300 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
//               aria-label="Close payment instructions popup"
//             >
//               Close
//             </button>
//           </div>
...
//                 className="bg-custom-blue1 text-white py-2 px-4 rounded-lg hover:bg-blue-950 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-custom-blue1 focus:ring-offset-2"
...
//                 className="bg-gray-200 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-300 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
...
const Pricing: React.FC = () => {
  ...
  const handleConfirmPurchase = async () => {
    ...
    try {
      await purchasePlan(selectedPlanId);
      setShowConfirmPopup(false);
      setShowSuccessPopup(true);
    } catch (err) {
      const errorMessage =
        err instanceof Error ? err.message : "Failed to purchase plan";
      setError(errorMessage);
      setShowConfirmPopup(false);
    }
  };
              ...
              <div className={getGridClass()}>
                {pricePlans.map((plan) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() => handlePurchaseClick(plan._id)}
                      className="mt-4 w-full bg-custom-blue1 text-white py-2 px-4 rounded-lg hover:bg-blue-950 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-custom-blue1 focus:ring-offset-2 text-base sm:text-lg"
                      aria-label={`Purchase ${plan.name} plan`}
                    >
                      Purchase
