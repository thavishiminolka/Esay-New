...
//     let score = 0
//     const marksPerQuestion = 5 // Each question is worth 5 marks

//     questions.forEach((question) => {
//       const userAnswer = userAnswers[question._id!]
//       const correctAnswer = question.answers.find((ans) => ans.isCorrect)?.text
...
//         console.log(`  Result: Incorrect (userAnswer or correctAnswer is undefined)`)
//         return
//       }
...
//         console.log(`  Result: Correct (+${marksPerQuestion} marks)`)
//       } else {
//         console.log(`  Result: Incorrect`)
//       }
//     })

//     console.log(`Total Score: ${score}/${questions.length * marksPerQuestion}`)
//     return score
//   }
...
//   const totalPossibleMarks = totalQuestions * 5 // Each question is worth 5 marks
...
//     if (!userAnswer || !correctAnswer) {
//       return true // Treat unanswered questions as incorrect
//     }
...
//                           <span className="text-green-600">{correctAnswer || "Not specified"}</span>
//                         </div>
//                       )}
...
//                               ? userAnswer.trim().toLowerCase() === answer.text.trim().toLowerCase()
//                               : false
//                             return (
//                               <li
//                                 key={answer.text}
...
//       {/* <div className="p-6 bg-gray-50 border-t border-gray-200 flex justify-between no-print">
//         <button
//           onClick={handlePrint}
...
//       <div className="hidden print-only p-4 text-center text-sm text-gray-500 border-t">
//         This is an official exam result document. Generated on {new Date().toLocaleDateString()}.
//       </div> */}
//     </div>
//   )
// }
  ...
  const calculateScore = () => {
    ...
    questions.forEach((question) => {
      ...
      if (!userAnswer || !correctAnswerValue) {
        console.log(`  Result: Incorrect (userAnswer or correctAnswerValue is undefined)`)
        return
      }
