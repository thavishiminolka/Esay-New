...
//       console.log("Save operation skipped: already saving or already saved");
//       return;
//     }
...
//     const examId = questions[0]?.examId || "default-exam-id"
...
//       alert("Result saved successfully!") // Alert only once after successful save
//       setHasSaved(true)
//     } catch (error: unknown) {
...
//                 (isSaving || hasSaved) ? "opacity-50 cursor-not-allowed" : ""
//               }`}
//               disabled={isSaving || hasSaved}
//             >
//               {isSaving ? "Saving..." : hasSaved ? "Result Saved" : "Finish Exam and Save"}
//             </button>
//           </div>
//         </div>
...
//   questions: Question[]
//   userAnswers: { [key: string]: string }
//   examId: string | null // Updated to string | null
// }

// const ExamResult: React.FC<ExamResultProps> = ({ questions, userAnswers, examId }) => {
//   const [activeTab, setActiveTab] = useState<"all" | "correct" | "incorrect">("all")
//   const [expandedQuestions, setExpandedQuestions] = useState<Set<string>>(new Set())
//   const [isPrinting, setIsPrinting] = useState(false)
//   const [isSaving, setIsSaving] = useState(false)
...
//     if (!examId) {
//       alert("No exam ID available. Cannot save result.")
//       setIsSaving(false)
//       return
//     }
