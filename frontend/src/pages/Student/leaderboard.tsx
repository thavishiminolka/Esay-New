...
//                 <div className="grid grid-cols-3 text-black font-semibold p-2 ubuntu text-sm sm:text-base min-w-[600px]">
...
//                         className="grid grid-cols-3 bg-custom-blue5 p-4 rounded-md text-black ubuntu text-sm sm:text-base"
//                       >
//                         <div>{entry.rank}</div>
...
//     position: winner.rank,
//     name: winner.name || "Unknown",
//     lName: winner.lName || "", // Added fallback to empty string
//     medal: index === 0 ? "🏆" : index === 1 ? "🥈" : "🥉",
//   }));
                ...
                <div className="space-y-2 p-0 min-w-[600px]">
                  {leaderboardData.length === 0 ? (
                    ...
                    leaderboardData.map((entry) => (
                      ...
                      >
                        <div>{entry.rank}</div>
                        <div className="text-center">{entry.name || "Unknown"} {entry.lName || "Unknown"}     </div>
