...
export default function GuidelinesPage() {
  ...
  useEffect(() => {
    const loadExam = async () => {
      ...
      try {
        ...
        if (!data.guidelines) {
          console.warn("Guidelines field is missing or undefined in the response");
          data.guidelines = [];
        }
  ...
  const startExam = () => {
    ...
    console.log("Starting new exam, clearing all previous state for exam ID:", id);
    ...
    if (exam && exam.questions) {
      exam.questions.forEach((question) => {
        const questionKey = `question-${question._id || question.questionNumber}-playCount`;
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#d6e4ed] rounded-lg p-8 mb-6">
            ...
            {exam.guidelines && exam.guidelines.length > 0 ? (
              ...
              <p className="text-center text-[#1a3a54]">No guidelines available for this exam.</p>
            )}
          </div>
          <div className="flex justify-center">
            <Button
